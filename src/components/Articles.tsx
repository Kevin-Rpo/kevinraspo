        ...
        <div className="grid md:grid-cols-3 gap-8">
          {articles.map((article, index) => (
            <a
              ...
              className="group bg-black/30 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 hover:border-gray-600 transition-all duration-500 hover:shadow-xl hover:shadow-gray-900/20 hover:scale-105 animate-[fade-in_1s_ease-out] block"
              style={{
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <FileText className="w-8 h-8 text-gray-400 mt-1 group-hover:text-gray-300 transition-colors" />
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-white mb-4 group-hover:text-gray-300 transition-colors leading-tight">
                    {article.title}
                  </h3>
                  <div className="flex items-center gap-2 text-gray-400 group-hover:text-gray-300 transition-colors">
                    <span className="text-sm">Read on LinkedIn</span>
